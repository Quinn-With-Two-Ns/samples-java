...
public class EncryptedPayloadsActivity {
  ...
  private static final Logger log = LoggerFactory.getLogger(EncryptedPayloadsActivity.class);

  static final String TASK_QUEUE = "EncryptedPayloads";

  static final String KMS_KEY =
      "aws-kms://INSERT KMS KEY ARN HERE";
  ...
  public static class GreetingWorkflowImpl implements GreetingWorkflow {
    ...
    public String getGreeting(String name) {
      ...
      log.info("Call composeGreeting");
      return greeting + activities.composeGreeting("Hello", name);
    }
  }
  ...
  public static void main(String[] args) {
    ...
    try {
      AeadConfig.register();
      // Fetch the AWS KMS key
      Aead reamoteAead = new AwsKmsClient().withDefaultCredentials().getAead(KMS_KEY);
      tinkHandle = KmsEnvelopeAead.create(PredefinedAeadParameters.AES128_GCM, reamoteAead);
            ...
            WorkflowClientOptions.newBuilder()
                .setDataConverter(
                    new CodecDataConverter(
                        ...
                        Collections.singletonList(new TinkCodec(tinkHandle))))
                .build());
